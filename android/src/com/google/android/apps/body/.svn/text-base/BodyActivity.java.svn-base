...
public class BodyActivity extends Activity implements
    ...
    private static final String ANALYTICS_ACCOUNT_ID = "TODO(embedder)";  // Dogfood builds.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.btn_header_layer) != null) mBodyUi = new PhoneUi(this);
        else                                             mBodyUi = new TabletUi(this);
